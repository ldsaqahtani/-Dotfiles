...
// Here I put "FINALS" as my finals are very close 
const EVENT_NAME = "FINALS";
...
const START_DATE = new Date(2025, 3, 14);  //  April 14, 2025
const END_DATE = new Date(2025, 4, 14);    // May 14, 2025
...
const BG_IMAGE_URL = "https://imgur.com/a/CBG77RY";

// STEP 4: Customize the appearance (optional)
// Background overlay color and opacity
const BG_COLOR = "#403260";       // Overlay color in hex format
...
const COLOR_UNFILLED = new Color("#F5EEDC", 0.4);  // Color for remaining days

// STEP 5: Layout settings
// These are optimized for my iPhone 16e. You may need to adjust for different devices.
// Increase values for larger screens, decrease for smaller screens.
const PADDING = 6;           // Space around the edges of the widget
const CIRCLE_SIZE = 4;       // Size of the progress dots
const CIRCLE_SPACING = 2;    // Space between dots
const TEXT_SPACING = 6;      // Space between dot grid and text
